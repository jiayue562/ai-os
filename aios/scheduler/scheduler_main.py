...
class SchedulerSession:
    ...
    def __init__(self, session_id: str = None, user_id: str = "悟空"):
        """初始化调度器会话"""
        import uuid
        self.session_id = session_id or f"SES_{uuid.uuid4().hex[:8].upper()}"
        ...
        self.context = {}  # 上下文
        self.skill_results = []  # 技能执行结果
        self.final_result = None
        self.precipitation_card = None
    ...
    def add_dialogue_turn(self, role: str, content: str, metadata: Dict = None):
        """添加对话轮次"""
        ...
        self.turn_count = len(self.dialogue_history)
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            "has_precipitation_card": self.precipitation_card is not None,
